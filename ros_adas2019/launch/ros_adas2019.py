...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        uss_side_left_frame, uss_rear_left_frame, uss_rear_center_frame, uss_rear_right_frame, uss_side_right_frame
        ])
